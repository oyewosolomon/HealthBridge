    ...
    <section id="contact" className="py-24 bg-muted/50">
      <div className="container">
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-muted-foreground text-lg">Email: contact@healthbridgesolutions.com</p>
          <p className="text-muted-foreground text-lg">Phone: +1 (555) 123-4567</p>
          <p className="text-muted-foreground text-lg">Address: 123 Health Street, Suite 100, City, State</p>
